...
Both recordings use the tested [v0.1.50 APK](https://github.com/isomorphisms/wegert/releases/tag/v0.1.50) from the current drag implementation.

- [Add and drag one zero/hole and one pole](docs/demos/add-and-drag-zero-and-pole.mp4)
- [Add and drag two zeros/holes and two poles](docs/demos/add-and-drag-two-zeros-and-two-poles.mp4)
